...
<body>
	<form name="add" action="<%=path%>/Class/Class_add.action"
		method="post">
		<table class="default" width="100%">
			...
			<tr>
				...
				<td class="list"><input type="text" name="cteacher" id="cteacher"></td>
			</tr>
			<tr>
				<td class="title">课时:</td>
				<td class="list"><input type="text" name="ctime" id="ctime"></td>
			</tr>
		</table>
